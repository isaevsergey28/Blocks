...
- (void)didDisplayAd:(MAAd *)ad
{
    ...
    {
        [SayUnityStateController UnityPause:true];
        [[SayKitEvent sharedInstance] track:@"max_unity_state" param1:1 param2:1 extra:@"paused" param3:0 param4:0 extra2:@"didDisplayAd" tag:@""];
    ...
    {
        [SayUnityStateController UnityPause:true];
        [[SayKitEvent sharedInstance] track:@"max_unity_state" param1:1 param2:2 extra:@"paused" param3:0 param4:0 extra2:@"didDisplayAd" tag:@""];
...
{
    [SayUnityStateController UnityPause:false];
    ...
    if ( MAAdFormat.interstitial == adFormat )
    {
        [[SayKitEvent sharedInstance] track:@"max_unity_state" param1:0 param2:1 extra:@"resumed" param3:0 param4:0 extra2:@"didFailToDisplayAd" tag:@""];
        
        name = @"OnInterstitialAdFailedToDisplayEvent";
    }
    else if ( MAAdFormat.rewarded == adFormat )
    {
        [[SayKitEvent sharedInstance] track:@"max_unity_state" param1:0 param2:2 extra:@"resumed" param3:0 param4:0 extra2:@"didFailToDisplayAd" tag:@""];
...
- (void)didHideAd:(MAAd *)ad
{
    ...
    if ( MAAdFormat.interstitial == adFormat )
    {
        [[SayKitEvent sharedInstance] track:@"max_unity_state" param1:0 param2:1 extra:@"resumed" param3:0 param4:0 extra2:@"didHideAd" tag:@""];
        
        name = @"OnInterstitialHiddenEvent";
    }
    else if ( MAAdFormat.rewarded == adFormat )
    {
        [[SayKitEvent sharedInstance] track:@"max_unity_state" param1:0 param2:2 extra:@"resumed" param3:0 param4:0 extra2:@"didHideAd" tag:@""];
...
{
    [SayUnityStateController UnityPause:false];
    [[SayKitEvent sharedInstance] track:@"max_unity_state" param1:0 param2:4 extra:@"resumed" param3:0 param4:0 extra2:@"didCollapseAd" tag:@""];
...
{
    [SayUnityStateController UnityPause:true];
    [[SayKitEvent sharedInstance] track:@"max_unity_state" param1:1 param2:4 extra:@"paused" param3:0 param4:0 extra2:@"didExpandAd" tag:@""];
