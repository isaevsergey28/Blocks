 ...
 * for different users based on the id<FBBKABTestSegment> they're associated with, which are
 * determined by id<FBBKABTest>. Each segment is associated with a set of real-time bidders.
